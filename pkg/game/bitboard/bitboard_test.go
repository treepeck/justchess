...
func TestMakeMove(t *testing.T) {
	testcases := []struct {
		...
		{
			"r2qk2r/8/2nbbn2/pppppppp/PPPPPPPP/2NBBN2/8/R2Q1RK1 w HQkq - 0 1 | Black O-O",
			[12]uint64{4278190080, 1095216660480, 2359296, 39582418599936,
				1572864, 26388279066624, 33, 9295429630892703744, 8,
				576460752303423488, 64, 1152921504606846976,
			},
			NewMove(enums.G8, enums.E8, enums.KingCastle),
			[12]uint64{4278190080, 1095216660480, 2359296,
				39582418599936, 1572864, 26388279066624, 33,
				2377900603251621888, 8, 576460752303423488, 64,
				4611686018427387904,
			},
		},
		{
...
func TestGenLegalMoves(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			NewBitboard([12]uint64{
				0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0,
				0x10000000000000, 0x0, 0x1000000000000000, 0x0,
			}, enums.Black, [4]bool{false, false, false, false},
				enums.NoSquare, 0, 1),
			[]Move{},
		},
		{
